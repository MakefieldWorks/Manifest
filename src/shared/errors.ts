...
export const ErrorCode = {
  HISTORY_OPERATION_FAILED: 'HISTORY_OPERATION_FAILED',
  HISTORY_OPERATION_PENDING: 'HISTORY_OPERATION_PENDING',
  EXTERNAL_DOCUMENT_CHANGED: 'EXTERNAL_DOCUMENT_CHANGED',
  ARCHIVE_FAILED: 'ARCHIVE_FAILED',
  GIT_CORRUPT:           'GIT_CORRUPT',
  GIT_COMMIT_FAILED:     'GIT_COMMIT_FAILED',
  SNAPSHOT_READ_FAILED:  'SNAPSHOT_READ_FAILED',
  HISTORY_METADATA_UNAVAILABLE: 'HISTORY_METADATA_UNAVAILABLE',
  HISTORY_BACKUP_FAILED: 'HISTORY_BACKUP_FAILED',
